...
BOOST_AUTO_TEST_CASE(validation_chainstate_resize_caches)
{
    ...
    CTxMemPool& mempool_candidate = *Assert(m_node.mempool_candidate);
    Chainstate& c1 = WITH_LOCK(cs_main, return manager.InitializeChainstate(&mempool, &mempool_candidate));
    c1.InitCoinsDB(
